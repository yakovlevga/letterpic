...
var getDefinedColorByString = function (settings, s) {
    var colors = settings.colors || defaultColors;
    return getItemByString(s, colors);
};

var palette = function (text, key, settings) {
...
var gradient = function (text, key, settings) {
    var context = getPreparedCanvasContext(settings);
    var gradient;
...
var color = function (text, key, settings) {
    var context = getPreparedCanvasContext(settings);
